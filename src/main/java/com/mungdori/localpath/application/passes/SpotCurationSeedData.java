    ...
    public static List<SpotCuration> curations() {
        return List.of(
                ...
                c("호돌이 닭강정 - 망원시장점",
                        "양념 닭강정 · 후라이드",
                        "평일 오후 3~5시 (한산한 시간)",
                        "시장 입구 쪽 매장이 줄이 짧아요. 방금 튀긴 닭강정이 가장 바삭합니다."),
                c("최네집 떡볶이 - 망원시장점",
                        "국물 떡볶이 · 순대",
                        "평일 오후 2~4시",
                        "골목 안쪽 지점이 한산할 때가 많아요. 순대는 기본 양념에 찍어 먹기 좋습니다."),
                c("할매순대국 - 망원시장점",
                        "얼큰 순대국 · 뼈해장국",
                        "아침 8~9시 또는 저녁 6시 이후",
                ...
                c("삼봉식당 - 망리단길점",
                        "연어 초밥 · 우동",
                        "평일 점심 11시 40분 전",
                        "카운터 좌석이 회전이 빨라요. 점심 세트는 가성비가 좋습니다."),
                c("연어삼촌 - 망리단길점",
                        "연어 덮밥 · 사시미",
                        "평일 점심 12시 전",
                        "덮밥은 기본 사이즈도 든든해요. 테이크아웃은 포장 대기가 짧습니다."),
                c("오향족발 - 망원시장점",
                        "마늘족발 · 모듬 보쌈",
                        "저녁 6시 30분~8시",
                ...
                c("망원책방 노트 - 망원점",
                        "추천 도서 · 잡지",
                        "평일 오후 2~6시",
                        "2층 창가 자리에서 잠깐 쉬어가기 좋아요. 기념 스탬프도 받을 수 있어요."),
                c("망원한강공원",
                        "야경 산책 · 피크닉",
                        "일몰 30분 전 (계절별 17~19시)",
